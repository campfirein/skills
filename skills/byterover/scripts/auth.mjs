...
var CODE_POINTS, init_unicode = __esm({
  "../../node_modules/.pnpm/parse5@8.0.1/node_modules/parse5/dist/common/unicode.js"() {
...
var State, TokenizerMode, init_tokenizer = __esm({
  "../../node_modules/.pnpm/parse5@8.0.1/node_modules/parse5/dist/tokenizer/index.js"() {
    init_preprocessor();
    init_unicode();
    init_token();
...
var IMPLICIT_END_TAG_REQUIRED, IMPLICIT_END_TAG_REQUIRED_THOROUGHLY, SCOPING_ELEMENTS_HTML, SCOPING_ELEMENTS_HTML_LIST, SCOPING_ELEMENTS_HTML_BUTTON, SCOPING_ELEMENTS_MATHML, SCOPING_ELEMENTS_SVG, TABLE_ROW_CONTEXT, TABLE_BODY_CONTEXT, TABLE_CONTEXT, TABLE_CELLS, init_open_element_stack = __esm({
  "../../node_modules/.pnpm/parse5@8.0.1/node_modules/parse5/dist/parser/open-element-stack.js"() {
    init_html();
...
var EntryType, MARKER, init_formatting_element_list = __esm({
  "../../node_modules/.pnpm/parse5@8.0.1/node_modules/parse5/dist/parser/formatting-element-list.js"() {
    (function(EntryType2) {
...
var QUIRKS_MODE_PUBLIC_ID_PREFIXES, QUIRKS_MODE_NO_SYSTEM_ID_PUBLIC_ID_PREFIXES, LIMITED_QUIRKS_PUBLIC_ID_PREFIXES, LIMITED_QUIRKS_WITH_SYSTEM_ID_PUBLIC_ID_PREFIXES, init_doctype = __esm({
  "../../node_modules/.pnpm/parse5@8.0.1/node_modules/parse5/dist/common/doctype.js"() {
    init_html();
...
var SVG_ATTRS_ADJUSTMENT_MAP, XML_ATTRS_ADJUSTMENT_MAP, SVG_TAG_NAMES_ADJUSTMENT_MAP, EXITS_FOREIGN_CONTENT, init_foreign_content = __esm({
  "../../node_modules/.pnpm/parse5@8.0.1/node_modules/parse5/dist/common/foreign-content.js"() {
    init_html();
...
var InsertionMode, TABLE_STRUCTURE_TAGS, TABLE_VOID_ELEMENTS, init_parser = __esm({
  "../../node_modules/.pnpm/parse5@8.0.1/node_modules/parse5/dist/parser/index.js"() {
    init_tokenizer();
    ...
    TABLE_STRUCTURE_TAGS = /* @__PURE__ */ new Set([TAG_ID.TABLE, TAG_ID.TBODY, TAG_ID.TFOOT, TAG_ID.THEAD, TAG_ID.TR]), TABLE_VOID_ELEMENTS = /* @__PURE__ */ new Set([TAG_ID.CAPTION, TAG_ID.COL, TAG_ID.COLGROUP, TAG_ID.TBODY, TAG_ID.TD, TAG_ID.TFOOT, TAG_ID.TH, TAG_ID.THEAD, TAG_ID.TR]);
  }
});
...
var init_cas_atomic_write = __esm({
  "../../packages/storage/src/cas-atomic-write.ts"() {
  }
});
...
var init_file_key_storage = __esm({
  "../../packages/storage/src/file-key-storage.ts"() {
    init_cas_atomic_write();
    init_paths();
  }
...
var PROJECTS_DIRNAME, GLOBAL_DATA_DIRNAME, init_paths2 = __esm({
  "../../packages/core/src/tree/paths.ts"() {
    init_uuid_v4();
    PROJECTS_DIRNAME = "projects", GLOBAL_DATA_DIRNAME = "brv";
  }
});
...
if (keyFile || positional) {
  let result = keyFile ? await authByterover((await readFile4(keyFile, "utf8")).trim()) : await authByterover(positional);
